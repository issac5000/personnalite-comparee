 ...
 [
  {
    ...
    "options": [
      {
        "text": "Il agit selon ce qu’il ressent comme juste, même si personne ne l’approuve.",
        "functions": { "Fi": 2, "Ne": 1 },
        "enneagram": { "1": 2, "4": 1 }
      },
      {
        "text": "Il s’efface souvent pour aider ou soutenir les autres.",
        "functions": { "Fe": 3 },
        "enneagram": { "2": 2, "9": 1 }
      },
      {
        "text": "Il prend des décisions rapides, orientées résultats.",
        "functions": { "Te": 3 },
        "enneagram": { "3": 2, "8": 1 }
      },
      {
        "text": "Il remet tout en question jusqu’à comprendre totalement.",
        "functions": { "Ti": 3 },
        "enneagram": { "5": 1, "1": 2 }
      }
    ]
  },
  {
    ...
    "options": [
      {
        "text": "Il vit dans ses souvenirs, ses habitudes sont rassurantes.",
        "functions": { "Si": 3 },
        "enneagram": { "6": 2, "9": 1 }
      },
      {
        "text": "Il capte tous les détails de l’environnement et agit vite.",
        "functions": { "Se": 3 },
        "enneagram": { "7": 2, "8": 1 }
      },
      {
        "text": "Il imagine le futur comme une histoire intérieure.",
        "functions": { "Ni": 2, "Ne": 1 },
        "enneagram": { "4": 2, "5": 1 }
      },
      {
        "text": "Il saute d’une idée à l’autre avec enthousiasme.",
        "functions": { "Ne": 2, "Se": 1 },
        "enneagram": { "7": 2, "2": 1 }
      }
    ]
