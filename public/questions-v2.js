  ...
  },
{
  ...
  },
 {
  ...
  },
  {
    ...
    options: [
      { text: "Apaiser les tensions et cherche l’harmonie.", functions: { Fe: 3, Ti: -1 }, enneagram: { "9": 2, "2": 1 } },
  ...
  },
 {
  ...
  },
  {
    ...
    options: [
      { text: "Suit l’intuition globale.", functions: { Ni: 3, Se: -1 }, enneagram: { "5": 1, "9": 2 } },
      { text: "Tente directement et ajuste.", functions: { Se: 3, Ni: -1 }, enneagram: { "8": 2, "7": 1 } },
      { text: "Fait plusieurs scénarios mentaux.", functions: { Ne: 3, Si: -1 }, enneagram: { "7": 2, "5": 1 } },
      { text: "Réplique un précédent fiable.", functions: { Si: 3, Ne: -1 }, enneagram: { "6": 2, "1": 1 } }
    ]
  },
  {
    id: 12,
  ...
  },
  {
    ...
    options: [
      { text: "Corrige le process durablement.", functions: { Te: 3, Fi: -1, Si: 1 }, enneagram: { "1": 2, "3": 1 } },
      { text: "Comprend le mécanisme de la faille.", functions: { Ti: 3, Fe: -1, Ni: 1 }, enneagram: { "5": 2, "1": 1 } },
      { text: "Repère les patterns annonciateurs.", functions: { Ni: 3, Se: -1 }, enneagram: { "5": 1, "9": 2 } },
      { text: "Refait un test concret de sécurité.", functions: { Se: 3, Ni: -1 }, enneagram: { "8": 2, "7": 1 } }
    ]
  },
  {
    id: 14,
  ...
  },
  {
    ...
    options: [
      { text: "Observe d’abord les usages établis.", functions: { Si: 3, Ne: -1 }, enneagram: { "6": 2, "1": 1 } },
      { text: "Imagine des variantes originales.", functions: { Ne: 3, Si: -1, Ti: 1 }, enneagram: { "7": 2, "5": 1 } },
      { text: "Capte rapidement l’intention profonde.", functions: { Ni: 3, Se: -1 }, enneagram: { "5": 1, "9": 2 } },
      { text: "Essaie tout de suite pour sentir.", functions: { Se: 3, Ni: -1 }, enneagram: { "8": 2, "7": 1 } }
    ]
  },
  {
    id: 17,
    ...
    options: [
      { text: "S’aligne si c’est logique et utile.", functions: { Ti: 3, Fe: -1 }, enneagram: { "5": 2, "1": 1 } },
      { text: "S’aligne si c’est humainement juste.", functions: { Fe: 3, Ti: -1 }, enneagram: { "2": 2, "9": 1 } },
      { text: "S’aligne si c’est efficace pour livrer.", functions: { Te: 3, Fi: -1 }, enneagram: { "3": 2, "8": 1 } },
      { text: "S’aligne si ça respecte ses valeurs.", functions: { Fi: 3, Te: -1 }, enneagram: { "4": 2, "9": 1 } }
    ]
  },
  {
    id: 18,
